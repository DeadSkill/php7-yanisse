...
<html lang="fr">
  ...
  <body class="text-center">
    ...
    <form action="creer-teams.php" method="POST">
        <div class="form-group">
            <br>
            <br>
            <br>
        <h1 class="cover-heading">Crée tes équipes.</h1>
              <label for="formGroupExampleInput">Entre le nom de l'équipe à créer.</label>
              <input type="text" class="form-control" name="name" placeholder="Nom de l'équipe">
        </div>
            <p class="lead">
              <!-- <a href="choix.php" class="btn btn-lg btn-secondary">Créer</a> -->
              <button type="submit" class="btn btn-primary" onclick="alert('Equipe créée avec succès! Tu peux continuer :)');" >Créer</button>
            </p>

            <h1 class="cover-heading">Tu as déjà créé tes équipes ?</h1>
                <p class="lead">
                  <a href="creer-joueur.php" class="btn btn-lg btn-secondary">Continue</a>
                </p>
