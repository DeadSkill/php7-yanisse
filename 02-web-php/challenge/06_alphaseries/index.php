<!doctype html>
 ...
 <body>
     ...
     <main role="main">
         <!-- Header -->
         <?php require_once(__DIR__.'/src/randomBanner.php');?>
         ...
         <div class="container">
             <div class="row">
                    <?php require_once(__DIR__.'/src/PopularShows.php');
                     $rank = 0;
                     ?>
                 ...
                 <div class="col-md-6">
                     ...
                     <?php for($i = 0; $i < count($popularShows); $i++){ $rank++;?>
                            <p>
                                <div class="card">
                                  <img class="card-img-top" src="<?php echo $popularShows[$i]['images']['banner']; ?>">
                                  <div class="card-body">
                                      <h5 class="card-title"><?php echo '#'. $rank . ' - ';?> <a href="serie.html"> <?php echo $popularShows[$i]['name'] ?></a></h5>
                                      <p class="card-text"> <?php echo $popularShows[$i]['statistics']['popularity'] . ' personnes regardent cette série.' ?></p>
                                  </div>
                                </div>
                            </p>
                         <?php } ?>
                 ...
                 <?php require_once(__DIR__.'/src/RatingShows.php');
                  $rank = 0;
                  ?>
                 <div class="col-md-6">
                     <h2><i class="fa fa-star"></i> Les mieux notées</h2>
                     <p>Les séries qui ont eu les meilleures notes.</p>
                      <?php for($i = 0; $i < count($marksShows); $i++){ $rank++; ?>
                     <p>
                         <div class="card">
                           <img class="card-img-top" src="<?php echo $marksShows[$i]['images']['banner']; ?>">
                           <div class="card-body">
                               <h5 class="card-title"><?php echo '#'. $rank . ' - ';?><a href="serie.html"> <?php echo $marksShows[$i]['name'] ?></a></h5>
                               <p class="card-text"><?php echo 'La serie a une note de ' . $marksShows[$i]['statistics']['rating'] .  '/5' ?></p>
                           </div>
                         </div>
                     </p>
